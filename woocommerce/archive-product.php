...
<?php if (is_shop()) : ?>
    <section class="catalog-info section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2>Наука, которая работает на результат</h2>
                    <div class="catalog-info__text">
                        В каталоге Laboratory Cytolife представлены современные решения для эстетической медицины: изделия медицинского назначения для биоревитализации кожи с запатентованными биодоступными формулами, стерильные концентраты для аппаратных методик, химические пилинги и профессиональные уходовые средства для эффективной и безопасной практики.
                    </div>
                    <p>
                        Откройте для себя науку в красоте вместе с Laboratory Cytolifе.
                    </p>
                </div>
                <div class="col-md-6">
