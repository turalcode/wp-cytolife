...
<div class="single-article">
    ...
    <section class="single-article-anchor section--pt">
        <div class="container">
            ...
            <ul class="single-article-anchor-list">
                <li><a href="#section-1">Якорная ссылка 1</a></li>
                <li><a href="#section-2">Якорная ссылка 2</a></li>
                <li><a href="#section-3">Якорная ссылка 3</a></li>
                <li><a href="#section-4">Якорная ссылка 4</a></li>
            </ul>
        </div>
        <!-- /container -->
    </section>
        ...
        <div class="container">
            ...
            <div class="single-article-block-content">
                <div class="row">
                    ...
                    <div class="single-article-block-content-img col-12">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/test-single-article-block.jpg" alt="#">
                    </div>
                </div>
                <!-- /row -->
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="single-article-pagination-content">
                        <a href="#" class="single-article-pagination-content-item cb-button">
    ...
    <section id="section-4" class="single-article-block section section--pt">
        <div class="container">
